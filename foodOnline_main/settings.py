...
ALLOWED_HOSTS = ['192.46.232.124', '127.0.0.1', 'fooduzonline.shop', 'www.fooduzonline.shop']
...
MIDDLEWARE = [
    ...
    'orders.request_object.RequestObjectMiddleware', #custom middleware created to access request object in orders.model
]
